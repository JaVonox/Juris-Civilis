...
public class LoadMap : MonoBehaviour
{
    ...
    public void SelectProvince(ProvinceObject provToDisplay) //Updates province click
    {
        ...
        _provDetails.GetComponent<ProvinceViewerBehaviour>().DisplayProvince(provToDisplay, ref _culturesLoaded, ref _provincesLoaded, ref _empiresLoaded, ref _religionsLoaded); //Change province viewer screen
    }
}
