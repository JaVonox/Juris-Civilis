            ...
            try
            {
                ...
                switch (commandSplit[0].ToUpper())
                {
                    ...
                    case "ADD": //ADD (PROVID) (EMPIREID) - adds to empire without cost or restrictions
                        ...
                        if (Act.Actions.ForceConquerLand(provs[Convert.ToInt32(commandSplit[1])], empires[Convert.ToInt32(commandSplit[2])])) { ForceUpdate(ref loadedMap); return "Added new land"; }
